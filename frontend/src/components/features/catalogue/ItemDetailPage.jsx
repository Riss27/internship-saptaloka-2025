        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white rounded-3xl p-6 md:p-8 border border-slate-200 shadow-xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow">
              <h1 className="text-3xl md:text-4xl font-bold text-slate-800 mb-2">{item.name}</h1>
            ...
            {item.category && (
              <div className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
                ...
                <span className="bg-slate-100 text-slate-700 text-sm font-semibold px-4 py-1.5 rounded-full border border-slate-200">{item.category}</span>
              </div>
            )}
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm">
              ...
              <div className="text-slate-700 leading-relaxed whitespace-pre-line bg-slate-50 rounded-xl p-4 border border-slate-100">{item.description || "Tidak ada deskripsi tersedia."}</div>
            </div>
          </div>
        </div>
      </div>
