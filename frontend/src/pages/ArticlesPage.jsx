    ...
    <div className="bg-gradient-to-b from-emerald-50 to-white min-h-screen">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-emerald-800 mb-2">{t("articles_page.title")}</h1>
          <p className="text-slate-600 mb-8">{t("articles_page.subtitle")}</p>
        ...
        {filteredArticles.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-slate-600 text-lg mb-2">
              {t("articles_page.no_articles_found", "No articles found matching your search")} "{searchQuery}"
            </p>
