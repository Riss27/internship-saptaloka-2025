...
const AddIngredientPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/catalogue/ingredients"); // <-- Arahkan kembali ke list bahan
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <header className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-white">{isEditMode ? "Edit Ingredient" : "Add New Ingredient"}</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white/10 p-8 rounded-lg shadow-lg text-white">
        ...
        <InputField label="Name" name="name" value={formData.name} onChange={handleChange} required={true} placeholder="Nama bahan..." />
        ...
        <InputField label="Description" name="description" type="textarea" value={formData.description} onChange={handleChange} required={true} placeholder="Deskripsi bahan..." />
...
// Komponen InputField ini sama, jadi tidak perlu diubah
